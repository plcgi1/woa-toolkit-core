...
To build a web application with WOA, you handle each type of concern inside
...
Installation of Catalyst should be straightforward:
    ...
    # perl -MCPAN -e 'install WOA'
    # perl -MCPAN -e 'install WOAx'
    # perl -MCPAN -e 'install Plack::Middleware::WOAx'

or download it from L<github.com> and standard perl module install procedure
    # unpack tar.gz
    # cd tar.gz
    # perl Makefile.PL
    # make
