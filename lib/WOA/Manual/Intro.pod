...
WOA::Manual::Intro - Introduction to Catalyst

=head1 DESCRIPTION

This is a brief introduction to WOA. It explains the most important
features of how WOA works and shows how to get a simple application
up and running quickly. For an introduction (without code) to WOA
itself, and why you should be using it, see L<WOA::Manual::About>.
For a systematic step-by-step introduction to writing an application
with Catalyst, see L<WOA::Manual::Tutorial>.

=head2 What is WOA?

WOA - web oriented architecture -  is an web application toolkit, extremely flexible
yet extremely simple. Good organisation of code structure - is a easy support and  
